...
class ReportDownloads extends Component
{
    ...
    private const REPORT_TYPES = [
        ...
        'simple-datesheet' => ['simple-datesheet.xlsx', 'simple-datesheet.pdf'],
    ...
    private const GENERATOR_METHODS = [
        ...
        'simple-datesheet' => [['simple-datesheet.xlsx', 'simpleDatesheetExcel'], ['simple-datesheet.pdf', 'simpleDatesheetPdf']],
