...
<x-card class="max-w-4xl mx-auto">
    ...
    @if ($step === 'review')
        <div>
            ...
            <div class="mt-6 flex items-center gap-3">
                <x-btn wire:click="commitImport" wire:loading.attr="disabled" icon="check">
    ...
    @if ($step === 'done')
        <div>
            ...
            <div class="mt-6 flex items-center gap-3">
                <x-btn :href="route('sessions.show', $examSession)" wire:navigate icon="arrow-left">Back to Session</x-btn>
